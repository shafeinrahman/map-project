...
CREATE TABLE IF NOT EXISTS category ( -- Start table definition.
    category_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the category.
...
CREATE TABLE IF NOT EXISTS "user" ( -- Start table definition.
    user_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the user.
...
CREATE TABLE IF NOT EXISTS territory ( -- Start table definition.
    territory_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the territory.
...
CREATE TABLE IF NOT EXISTS route ( -- Start table definition.
    route_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the route.
...
CREATE TABLE IF NOT EXISTS business ( -- Start table definition.
    business_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the business.
...
CREATE TABLE IF NOT EXISTS delivery_event ( -- Start table definition.
    delivery_event_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the delivery event.
...
CREATE TABLE IF NOT EXISTS business_location_history ( -- Start table definition.
    history_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the history record.
...
CREATE TABLE IF NOT EXISTS outbox_event ( -- Start table definition.
    outbox_event_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the outbox event.
...
CREATE TABLE IF NOT EXISTS point_of_interest ( -- Start table definition.
    poi_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the point of interest.
...
CREATE TABLE IF NOT EXISTS query_log ( -- Start table definition.
    query_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Unique identifier for the query log.
